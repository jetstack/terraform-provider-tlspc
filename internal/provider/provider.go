...
We recommend that you create a custom user with the permissions required to manage the necessary resources, and use this user for performing terraform operations.
`,
